...
public class LanguageProviderZHCN extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(Constants.GUI_NARRATION_BUTTON_ADD, "添加 %1$s 标签");
        ...
        add(Constants.GUI_TITLE_TREE_VIEW_NARRATION, "NBT 树");
        ...
        add(Constants.GUI_BUTTON_SAVE_NARRATION, "保存");
        add(Constants.GUI_BUTTON_QUIT_NARRATION, "退出");
