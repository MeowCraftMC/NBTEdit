...
public class AccessibilityHelper {
    ...
    public static @Nullable Tooltip buildTooltip(Player player, NbtTree.Node<?> node) {
        var tag = node.getTag();
        ...
        var item = TagReadingHelper.tryReadItem(player, tag);
        if (item != null) {
            showPreview = true;
        ...
        var text = TagReadingHelper.tryReadText(player, tag);
